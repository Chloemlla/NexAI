        ...
        commandBar: Row(
          ...
          children: [
            fluent.FilledButton(
              child: const Row(
                children: [
                  Icon(fluent.FluentIcons.save, size: 14),
                  SizedBox(width: 8),
                  Text('Save All'),
                ],
              ),
              onPressed: () async {
                try {
                  ...
                  await settings.setModels(_modelsController.text);
                  await settings.setSystemPrompt(_systemPromptController.text);
                  await settings.setVertexProjectId(
                    _vertexProjectIdController.text,
                  );
                  await settings.setVertexLocation(
                    _vertexLocationController.text,
                  );
                  if (context.mounted) {
      ...
      children: [
        _fluentCard(theme, 'API Configuration', fluent.FluentIcons.cloud, [
          ...
          if (_currentApiMode == 'OpenAI') ...[
            ...
            fluent.InfoLabel(
              label: 'Project ID (Empty for Express Mode)',
              child: fluent.TextBox(
                controller: _vertexProjectIdController,
            ...
            const SizedBox(height: 16),
            fluent.InfoLabel(
              label: 'Location (e.g. us-central1 or global)',
              child: fluent.TextBox(
                controller: _vertexLocationController,
            ...
            child: Row(
              children: [
                Expanded(
                  child: fluent.TextBox(
                    controller: _apiKeyController,
                    placeholder: _currentApiMode == 'OpenAI'
                        ? 'sk-...'
                        : 'ya29... or AIza...',
                    obscureText: !_showApiKey,
                  ),
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: isSelected
                ...
                : Border.all(
                    color: displayColor.withAlpha((0.5 * 255).round()),
                  ),
            boxShadow: isSelected
                ? [
                    BoxShadow(
                      color: displayColor.withAlpha((0.4 * 255).round()),
                      blurRadius: 8,
